...
import freeBus1 from "../../../../../public/images/modernarch/FreeBus1.png"
import free1 from "../../../../../public/images/modernarch/Free1.png"
    ...
    return (
        <section className="modernarch">
            ...
            <div className="post">
                ...
                <div className="brand">
                    <Image src={free1} alt="post" />
                    <Image src={freeBus1} alt="post" />
                </div>
